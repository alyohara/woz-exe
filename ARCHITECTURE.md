...
- Fuentes: TTF embebida `assets/DejaVuSansMono*.ttf` vía `fonts.py` (definición
  nítida sin agrandar; evita el bitmap por defecto de pygame). En WASM:
  `smoothscale` al presentar.
